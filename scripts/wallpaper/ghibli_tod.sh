...
if [[ $((10#"$hour")) -gt 3 ]] && [[ $((10#"$hour")) -lt 17 ]]; then
    ...
    image=$(find /home/mark/Pictures/Wallpaper/new_ghibli_testing/Day/ -mindepth 1 | shuf -n 1)
fi

# if between 5pm and 3:59am (17:00 - 03:59)
if [[ $((10#"$hour")) -gt 16 ]] || [[ $(("$hour")) -lt 4 ]]; then
    # grab a random night time studio ghibli image
    image=$(find /home/mark/Pictures/Wallpaper/new_ghibli_testing/Night/ -mindepth 1 | shuf -n 1)
fi
