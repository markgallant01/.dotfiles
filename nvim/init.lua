...
require("solarized-osaka").setup({
  ...
  sidebars = { "qf", "help" },  day_brightness = 0.3,
  ...
  lualine_bold = false,
  --- You can override specific color groups to use other groups or a hex
  --- color function will be called with a ColorScheme table
